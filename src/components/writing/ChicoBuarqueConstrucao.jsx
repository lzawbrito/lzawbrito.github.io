...
export default class WritingComponent extends React.Component {
	render() {
		...
		<p>
			...
			Perhaps this was owed to his coinciding with the boom of the Tropicália movement—compared to the
			convention-breaking, free-form psychedelia of artists like Caetano Veloso, Chico’s pretty, clever lyrics and
			traditional instrumentation weren’t necessarily cutting-edge. But the turn of the decade saw a pivotal moment in
			Chico’s life: after publishing a seemingly anti-authoritarian play entitled “Roda Viva” in the late 60s, Chico
			was persecuted by the military dictatorship and subsequently fled to Rome. Story goes that, in between hiding in
		...
		<p>
			...
			for some time: Chico doesn’t let the tension go, he draws the moment out, letting the listener sit in the
			musical space the instrumentation sets up, and the poetic space his lyricism constructs. “For the free cachaça
			we have to swallow,” he continues, “For the smoke, disgrace, that we have to cough/For the scaffolding, hanging,
			from which we fall/May God pay you.” The song seems to be depicting a character cursing another person—or
			perhaps an entity—for a miserable quality of life. Despite seemingly depending on this individual or entity to
		...
		<p>
			...
			music in motion. Over this, he continues to sing in obtuse imagery: “Every day she does everything exactly the
			same/She shakes me awake at six in the morning/Smiles a punctual smile/And kisses me with a minty mouth.” His
		...
		<p>
			...
			persecuted for a play that did naught but encourage free thinking. The track Construção is the moment in the
			album—as well as in his socio-political commentary—where these loose ends come together. The track sees the
			narrative of the album laying itself out cohesively: “He loved that time as if it was the last/Kissed his wife
			as if she was his last/And each of his sons as if it was his only… Climbed up the construction site as if he was
			a machine.” This is, in spirit, the same man from Cotidiano: disillusioned, mechanical, beat down by… something.
			He kisses his family in a state of utter dread, then climbs up the construction site, no doubt using the
			scaffolding spoken of in “Deus Lhe Page.” Chico describes him placing brick after brick, eyes caked in cement
		...
		<p>
			...
			to “he loved that time as if he was a machine,” and similarly for the remainder of the verse. (<a
				...
				drawing—perhaps his proclivity for artistic expression—becomes equally rigid. And in spite of it all, Chico
				waves the story’s irony in the listener’s face: the “walls” the construction worker is confined by are not
				only
				“flaccid,” but constructed and upheld by the worker himself. The proletariat is oppressed insofar as he is
		...
		<p>
			...
			introduces a simple guitar/bass/drums phrase, then keys in some percussion—a subtle agogô. Then a horn hit,
			abrasive and sudden, and a full symphony kicks in; strings and brass, dancing around Chico’s lyrics, and
			background vocalists, drawing out tense—almost ugly—harmonies. Over a steady foundation, the song builds, as
			apocalyptic as it is mechanical, almost as if to mimic the titular construction site. When this tension is about
			to crack, when the mix has been maximally bombarded with sound, Chico shifts focus: he brings in the album’s
			opener as an outro section. “For this bread to eat/For this floor to sleep on,” he sings, once again. A
			mountainous, cinematic symphony lumbers over his vocals, and we at last realize what the singer was driving at
			with the opening track: this album tells the story of a class beat down by an uncaring and unforgiving system.
		...
		<p>
			...
			translation of the lyrics yourself and try to pick apart the allusions; the subtext is so vast, doing so myself
			would result in an unreasonably lengthy article. That said, I chose to break apart the first leg of the album
			because makes for a powerful comment on the Brazil of the 1970s, and a timeless statement on capitalism in
			general. With this in mind, it’s easy to see how the album made the impact that it did. Upon its release, it
			sold so well the record label had to double its vinyl pressing output by hiring a second manufacturer. To this
			day, it remains a critically lauded and culturally important work of Brazilian art, placing in the top ten of
			several “Best Albums” lists. And the most beautiful part is that Chico hid his criticisms so well, the
			dictatorship never really paid heed the album’s subtext. This is because, through his allusion-ridden style,
			Chico speaks in code in Construção; his code is the emotion of the proletariat, indecipherable to the authority.
			I find it incredible that his depiction of class oppression is so universal it can connect to an audience
