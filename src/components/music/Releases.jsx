export const releases = [
	{
		...
		bandcampEmbed: `
			...
			seamless><a href="https://lucaszbrito.bandcamp.com/album/laplacian-demon">Laplacian Demon by Lucas
            Brito</a></iframe>
			`,
...
`
			},
			{
				...
				when you're out
				Living through your days
				Just don't forget me
				at the turn of the key
				at the crack in the floor
				at the fall in the loop
				at the loop in the knot
				don't-
				...
				You spend all your time looking at me
				burying your hands in my hair
				it's been too long
				you need some sleep
				you need me
				come to me
				I want you to move your arms away from me
				...
				Mukilteo Speedway
				I watched the skeleton of the city,
				peeled by white light, unrolling
				I watched three boys underneath a stairway
				Letting frost through their teeth, letting their time kiss the night
				Time kiss the night
				Time kiss the night
				I watched you build this world where everyone's coked up and nothing feels either bad or alright
				`
			},
			{
			...
			},
			{
				...
				As the drier went on in the back
				"Oh," I said, looking at myself in the mirror
				Just yesterday I had done the same thing
				"Funny how we come back around like we're looping" you said through the tiles, as I touched my skin
				"It used to be my favorite song, and now I think it is again."
				I touched my skin. Ceramic flooring, the bathtub's filthy.
				The ceramic is smooth, I pictured myself slipping on it, hitting my head, and
				Walking down the stairs, to the supermarket.
				...
				As I was about to head out the door you told me: "Don't forget to pick up the filter."
				I told you I picked up the filter yesterday and you said "No, I had picked up the filter about a month ago. It had been about a month."
				I said I think remember damn well picking up what I picked up and doing what I did when I did.
				I saw a retort manifest in your eyes then pass, ephemeral. We both knew it was time for me to head out the door.
				"I've done everything I can, ok? I'm trying everything I can and doing all I can think of but it still doesn't seem to get any better, ok? Nothing's cutting it. None of the keys work on this lock, you know?"
				And then before I knew it I was walking on the sidewalk.
				I've done the math inside and outside and forwards and backwards, I've done the math my way, I've done it yours, I've done it right,
				I've done it wrong. I did it by hand, I did it with computers, I've done it inside and outside and forwards and backwards
				...
				As I walked outside I saw the faces of everyone I'd ever seen in my life like they were all waiting for me.
				I saw every friend I'd ever known, the boy I sat behind in kindergarten, my mother, my father, my lovers
