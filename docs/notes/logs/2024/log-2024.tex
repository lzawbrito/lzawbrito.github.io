...
\entry{Vierbeins, Tetrads, Spin Connections}{2/11/24}
...
\subsection{Stieffel-Whitney classes}
TODO
...
probability distribution. The machine itself consists of a set of units 
$ s_i $ and weights $ w_{ij} $ connecting each of those units.
